...
const DisplayPhones = (phone, datalimit) => {
    ...
    phone.forEach(phone => {
        ...
        <div class="card-body">
            ...
            <button onclick="LoadPhoneDetais('${phone.slug}')" href="" class="btn btn-primary"data-bs-toggle="modal" data-bs-target="#exampleModal">Show Details</button>
           </div>
         </div>
        `;
        // 04 append  ---------------------------------------------------------------------------
...
const DisplayPhoneDetails = phone => {
    ...
    <p>realase Date: ${phone.releaseDate ? phone.releaseDate : 'No Relese Date Found'}</p>
